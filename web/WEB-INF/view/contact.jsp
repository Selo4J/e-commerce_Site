<%-- 
    Document   : contact
    Created on : 17-Jun-2017, 01:16:16
    Author     : tomsol28
--%>
        ...
        <div class="span8 relative">
            ...
            <div class="absoluteBlk">
                <div class="well wellsmall">
                    ...
                    <h5>
                        20 Beacon Road<br/>
                        Ormskrik, Lancashire<br/><br/>

                        info@mysite.com<br/>
                        Tel 0044-2021-234-6780<br/>
        ...
        <div class="span4">
            ...
            <form class="form-horizontal">
                <fieldset>
                    ...
                    <button type="reset" name="submit" value="Clear" class="exclusive defaultBtn"> Clear Text</button>
