<%-- 
    Document   : itemWithRelated
    Created on : 17-Aug-2017, 00:33:41
    Author     : tomsol28
--%>
...
<div class="row">
    ...
    <div class="span9">
        ...
        <div class="well well-small">
            <div class="row-fluid">
                <c:if test="${!empty itemWithRelated}">
                    <div class="span5">
                        <div id="myCarousel" class="carousel slide cntr">
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img src="${initParam.productImagePath}${itemWithRelated.name}.png"
                    ...
                    <div class="span7">
                        ...
                        <form action="<c:url value='addToCart'/>" method="post" class="form-horizontal qtyFrm"> 
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="control-label"><span>&pound; ${itemWithRelated.price}</span></label>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><span>Quantity</span></label>
                                <div class="controls">
                                    <input type="number" class="span6" disabled placeholder="1" name="quantity">
                                </div>
                            </div>	
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select class="span11">
                                        <option>${itemWithRelated.brand}</option>
                            ...
                            <input type="hidden" name="productId" value="${itemWithRelated.id}">
                ...
                <div id="myTabContent" class="tab-content tabWrapper">
                    <div class="tab-pane fade active in" id="home">
                        ...
                        <table class="table table-striped">
                            <tbody>
                                <tr class="techSpecRow"><td class="techSpecTD1"><strong>Name:</strong></td><td class="techSpecTD2">${itemWithRelated.name}</td></tr>
                                <tr class="techSpecRow"><td class="techSpecTD1"><strong>Price:</strong></td><td class="techSpecTD2">&pound;${itemWithRelated.price}</td></tr>
                                <tr class="techSpecRow"><td class="techSpecTD1"><strong>Brand:</strong></td><td class="techSpecTD2">${itemWithRelated.brand}</td></tr>
                            </tbody>
                        </table>
                        <p> <strong> Description </strong></p>
                        <p>${itemWithRelated.description}</p>
                    </c:if>
                </div>
