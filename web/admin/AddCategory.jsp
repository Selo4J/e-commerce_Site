...
function getConfirmation(){
    ...
    //Get reference to the form elements:
     // var text ="You have been added successfully";
...
<div class="row">
    ...
    <div class="span9">
        <div class="well well-small">
            ...
            <h5 class="page-header"> ADD CATEGORY INFORMATION</h5>

            <p align="center"> Please enter category's name to add into database.</p>

            <form  id="addForm" action="<c:url value='AddCategory'/>" method="POST" class="form-horizontal" onsubmit="return getConfirmation()">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="name" placeholder="Enter category name" value="${param.name}" required>
