<%-- 
    Document   : EdProConfirmation
    Created on : 17-Aug-2017, 21:49:03
    Author     : tomsol28
--%>
...
<div class="well well-small">
       ...
       <h5 class="page-header">EDIT PRODUCT INFORMATION <a href="<c:url value='viewProducts'/>" class="shopBtn btn-large pull-right">
