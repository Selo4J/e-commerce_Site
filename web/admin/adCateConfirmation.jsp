<%-- 
    Document   : adCateConfirmation
    Created on : 18-Aug-2017, 00:06:51
    Author     : tomsol28
--%>
...
<div class="well well-small">
       ...
       <h5 class="page-header">ADD CATEGORY INFORMATION <a href="<c:url value='viewCategories'/>" class="shopBtn btn-large pull-right">
