<%-- 
    ...
    Created on : 09-Aug-2017, 02:46:11
    Author     : tomsol28
--%>
...
<div class="row">
    ...
    <div class="span9">
        <div class="well well-small">
            ...
            <h5 class="page-header">DELETED CATEGORY INFORMATION <a href="<c:url value='viewCategories'/>" class="shopBtn btn-large pull-right">
                    <span class="icon-arrow-left"></span><strong> Back Category Summary</strong></a></h5>

            <table class="table table-bordered table-striped">
                <tr class="header">
                    <th colspan="3" style="text-align: center"> The data have been successfully deleted! </th>
                </tr>
                <tr>
