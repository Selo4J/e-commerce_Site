<%-- 
    Document   : editSubConfirmation
    Created on : 13-Aug-2017, 00:45:20
    Author     : tomsol28
--%>
...
<div class="row">
    ...
    <div class="span9">
        <div class="well well-small">
            ...
            <h5 class="page-header">EDIT SUBCATEGORY INFORMATION <a href="<c:url value='viewSubcategories'/>" class="shopBtn btn-large pull-right">
                    <span class="icon-arrow-left"></span><strong> Back Subcategory Summary</strong></a></h5>

            <table class="table table-bordered table-striped">
                <tr class="header">
                    <th colspan="3" style="text-align: center">You have been updated successfully!</th>
                </tr>
                <tr>
        ...
        <div class="well well-small">
            <h3 class="page-header">SUBCATEGORY LIST</h3>
